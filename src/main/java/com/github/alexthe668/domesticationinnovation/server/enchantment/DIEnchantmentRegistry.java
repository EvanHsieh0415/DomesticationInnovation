...
public class DIEnchantmentRegistry {
    ...
    public static final PetEnchantment IMMUNITY_FRAME = new PetEnchantment("immunity_frame", Enchantment.Rarity.UNCOMMON, 3, 6);
    public static final PetEnchantment DEFLECTION = new PetEnchantment("deflection", Enchantment.Rarity.RARE, 1, 10);
    public static final PetEnchantment POISON_RESISTANCE = new PetEnchantment("poison_resistance", Enchantment.Rarity.COMMON, 1, 4);
    public static final PetEnchantment CHAIN_LIGHTNING = new PetEnchantment("chain_lightning", Enchantment.Rarity.RARE, 2, 8);
    ...
    public static final PetEnchantment MAGNETIC = new PetEnchantment("magnetic", Enchantment.Rarity.RARE, 1, 11);
    public static final PetEnchantment LINKED_INVENTORY = new PetEnchantment("linked_inventory", Enchantment.Rarity.COMMON, 1, 5);
    public static final PetEnchantment TOTAL_RECALL = new PetEnchantment("total_recall", Enchantment.Rarity.UNCOMMON, 1, 3);
    public static final PetEnchantment HEALTH_SIPHON = new PetEnchantment("health_siphon", Enchantment.Rarity.RARE, 1, 11);
    public static final PetEnchantment BUBBLING = new PetEnchantmentLootOnly("bubbling", Enchantment.Rarity.VERY_RARE, 2, 7);
    public static final PetEnchantment SHEPHERD = new PetEnchantment("herding", Enchantment.Rarity.UNCOMMON, 2, 5);
    ...
    public static final PetEnchantment VOID_CLOUD = new PetEnchantmentLootOnly("void_cloud", Enchantment.Rarity.VERY_RARE, 1, 9);
    public static final PetEnchantment CHARISMA = new PetEnchantmentTradeOnly("charisma", Enchantment.Rarity.VERY_RARE, 3, 7);
    public static final PetEnchantment SHADOW_HANDS = new PetEnchantment("shadow_hands", Enchantment.Rarity.VERY_RARE, 4, 8);
    public static final PetEnchantment DISK_JOCKEY = new PetEnchantment("disc_jockey", Enchantment.Rarity.RARE, 1, 6);
    public static final PetEnchantment DEFUSAL = new PetEnchantment("defusal", Enchantment.Rarity.UNCOMMON, 3, 14);
    public static final PetEnchantment WARPING_BITE = new PetEnchantment("warping_bite", Enchantment.Rarity.RARE, 1, 7);
    ...
    public static final PetEnchantment PSYCHIC_WALL = new PetEnchantment("psychic_wall", Enchantment.Rarity.VERY_RARE, 3, 9);
    public static final PetEnchantment INTIMIDATION = new PetEnchantment("intimidation", Enchantment.Rarity.UNCOMMON, 2, 8);
    public static final PetEnchantment TETHERED_TELEPORT = new PetEnchantment("tethered_teleport", Enchantment.Rarity.COMMON, 1, 4);
